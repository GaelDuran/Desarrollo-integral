...
var numeros2Cadena = document.getElementById('numeros2');
...
//Union de tipos
var miArray = ['Carlos', 24, 'Saul', 19, 'Luis', 25];
console.log(miArray);
var miArray2 = ['Mate', 'Rayo Mcqueen', 'Hudson Hurnet'];
console.log(miArray2);
var miArray3 = [true, 10, 'Hola', 20.5];
console.log(miArray3);
var miArray4 = []; //Arreglo vacio
miArray4.push(3);
miArray4.push(2);
miArray4.push(1);
...
miArray5.forEach(function (item) {
